...
export const metadata = {
  title: 'OCO Limited Services | Accounting, Advisory & CFO Services',
  description: 'OCO Limited provides comprehensive accounting, advisory, and fractional CFO services in the Isle of Man. Expert financial reporting, tax compliance, business valuation, and strategic planning by ACCA Fellow Gary O\'Connor.',
  keywords: [
    'OCO Limited services',
    'OCO accounting services',
    'OCO advisory services',
    'OCO CFO services',
    'accounting services Isle of Man',
    'advisory services Isle of Man',
    'fractional CFO services Isle of Man',

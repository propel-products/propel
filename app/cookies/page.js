    ...
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-white pt-32 pb-20">
        <div className="max-w-4xl mx-auto px-6">
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-8 text-center text-gray-900 dark:text-white">Cookie Policy</h1>
          ...
          <div className="prose prose-gray dark:prose-invert max-w-none text-gray-600 dark:text-gray-300 space-y-6 leading-relaxed">
            ...
            <section>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 mt-8">1. What Are Cookies?</h2>
              <p>
            ...
            <section>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 mt-8">2. How We Use Cookies</h2>
              <p>Propel uses cookies on our website (propel.im) for the following purposes:</p>
              
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Essential Cookies</h3>
              ...
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Analytics Cookies</h3>
              ...
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Functionality Cookies</h3>
            ...
            <section>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 mt-8">3. Third-Party Cookies</h2>
              <p className="mb-4">We may use third-party services that set cookies on our website such as:</p>
              
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Google Analytics (if enabled)</h3>
              <p className="mb-2">
            ...
            <section>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 mt-8">4. Types of Cookies We Use</h2>
              <div className="overflow-x-auto mt-4">
                <table className="w-full border-collapse border border-gray-200 dark:border-gray-700">
                  <thead>
                    <tr className="bg-gray-100 dark:bg-gray-900">
                      <th className="border border-gray-200 dark:border-gray-700 p-3 text-left">Cookie Name</th>
                      <th className="border border-gray-200 dark:border-gray-700 p-3 text-left">Purpose</th>
                      <th className="border border-gray-200 dark:border-gray-700 p-3 text-left">Duration</th>
                      <th className="border border-gray-200 dark:border-gray-700 p-3 text-left">Type</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="border border-gray-200 dark:border-gray-700 p-3">Session/Preferences</td>
                      <td className="border border-gray-200 dark:border-gray-700 p-3">Essential website functionality</td>
                      <td className="border border-gray-200 dark:border-gray-700 p-3">Session / 1 year</td>
                      <td className="border border-gray-200 dark:border-gray-700 p-3">Essential</td>
                    </tr>
                    <tr>
                      <td className="border border-gray-200 dark:border-gray-700 p-3">_vercel_analytics</td>
                      <td className="border border-gray-200 dark:border-gray-700 p-3">Website analytics (if enabled)</td>
                      <td className="border border-gray-200 dark:border-gray-700 p-3">2 years</td>
                      <td className="border border-gray-200 dark:border-gray-700 p-3">Analytics</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <section>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 mt-8">5. Managing Cookies</h2>
              <p>You can control and manage cookies in various ways:</p>
              
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Browser Settings</h3>
              ...
              <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">Browser-Specific Instructions</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 mt-8">6. Consent</h2>
              <p>
            ...
            <section>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 mt-8">7. Updates to This Cookie Policy</h2>
              <p>
            ...
            <section>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 mt-8">8. Contact Us</h2>
            ...
            <section>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4 mt-8">9. More Information</h2>
